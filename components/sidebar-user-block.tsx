...
export function SidebarUserBlock({ label, status = 'Activ', showSupport = false }: { label: string; status?: string; showSupport?: boolean }) {
  ...
  return (
    <div className="w-full pt-2 text-center">
      ...
      <div className="flex items-center justify-center gap-2.5 px-3 mb-2">
      ...
      {showSupport && (
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-500 hover:bg-white hover:shadow-sm transition mb-1"
        >
